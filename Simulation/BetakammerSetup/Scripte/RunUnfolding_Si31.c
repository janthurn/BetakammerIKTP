...
void RunUnfolding_Si31(){
  ...
  double Qwert =1491.5.5;
  double Upper_End =1500.0;
  ...
  //======================================================================================================================================
   ...
   sprintf(macroNamePart1,"%s/Betakammer/macros/unfolding/%s_unfolding_Position%i_Sonde%i",place,isotop,Position,SiliziumSonde);
	 sprintf(rootNamePart1,"%s/Simulationen/Raw_Files/%s_unfolding_Position%i_Sonde%i",place,isotop,Position,SiliziumSonde);
  ...
  //======================================================================================================================================
   ...
   for (int i = start; i <= stop; i++)    {
	  ...
	  //       file << "/MG/manager/heprandomseed " << time(0) + i "<< std::endl;
          ...
          file << "/BetaChamber/geometry/SiliziumDicke "<< Dicken[SiliziumSonde-1] <<std::endl;
