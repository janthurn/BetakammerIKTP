...
//
#ifndef BetaChamberGeneratorDecay0InterfaceMessenger_H
#define BetaChamberGeneratorDecay0InterfaceMessenger_H 1

class BetaChamberGeneratorDecay0Interface;
class G4UIdirectory;
...
class BetaChamberGeneratorDecay0InterfaceMessenger : public G4UImessenger
{
public:

  BetaChamberGeneratorDecay0InterfaceMessenger(BetaChamberGeneratorDecay0Interface*);
  ~BetaChamberGeneratorDecay0InterfaceMessenger();
  void SetNewValue(G4UIcommand*,G4String);

private:
  BetaChamberGeneratorDecay0Interface* fPointerToInterface;
