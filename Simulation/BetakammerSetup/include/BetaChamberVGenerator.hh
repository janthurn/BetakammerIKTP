...
#ifndef _BetaChamberVGenerator_HH
#define _BetaChamberVGenerator_HH
...
class BetaChamberVGenerator
{
public:

  //default constructor
  BetaChamberVGenerator();

  //copy constructor
  BetaChamberVGenerator(const BetaChamberVGenerator &);

  //destructor
  virtual ~BetaChamberVGenerator();
