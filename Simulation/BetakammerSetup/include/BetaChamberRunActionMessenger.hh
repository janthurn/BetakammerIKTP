   ...
   // * Neither the authors of this software system, nor their employing *
    ...
    #ifndef BetaChamberRunActionMessenger_h
    #define BetaChamberRunActionMessenger_h 1
    ...
    class BetaChamberRunActionMessenger: public G4UImessenger
    {
    public:
      BetaChamberRunActionMessenger(BetaChamberRunAction*);
      virtual ~BetaChamberRunActionMessenger();

      virtual void SetNewValue(G4UIcommand*, G4String);

    private:
      BetaChamberRunAction*            fRun;
