...
class G4Event;
class BetaChamberGeneratorDecay0InterfaceMessenger;

class BetaChamberGeneratorDecay0Interface : public G4VPrimaryGenerator
{
public:
  BetaChamberGeneratorDecay0Interface(G4String fileName);
  ~BetaChamberGeneratorDecay0Interface();
...
private:
  ...
  BetaChamberGeneratorDecay0InterfaceMessenger* fTheMessenger;
