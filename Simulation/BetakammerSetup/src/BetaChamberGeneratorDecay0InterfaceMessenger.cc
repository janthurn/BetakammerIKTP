...
BetaChamberGeneratorDecay0InterfaceMessenger::BetaChamberGeneratorDecay0InterfaceMessenger(BetaChamberGeneratorDecay0Interface* ptr) :
  fPointerToInterface(ptr)
{
  fDirectory = new G4UIdirectory("/BetaChamber/generator/decay0/");
  fDirectory->SetGuidance("Control of Decay0 event generator");

  fCommand = new G4UIcmdWithAString("/BetaChamber/generator/decay0/filename",this);
  fCommand->SetGuidance("Set the file name for decay0 events");

  fGammaKillCmd =  new G4UIcmdWithABool("/BetaChamber/generator/decay0/killGamma",this);
  fGammaKillCmd->SetGuidance("Ignore gammas emitted by decay0");
  fGammaKillCmd->SetGuidance("Default = false");

  fElectronKillCmd =  new G4UIcmdWithABool("/BetaChamber/generator/decay0/killElectron",this);
  fElectronKillCmd->SetGuidance("Ignore e- emitted by decay0");
  fElectronKillCmd->SetGuidance("Default = false");

  fPositronKillCmd =  new G4UIcmdWithABool("/BetaChamber/generator/decay0/killPositron",this);
  fPositronKillCmd->SetGuidance("Ignore e+ emitted by decay0");
  fPositronKillCmd->SetGuidance("Default = false");

  fRecycleFileCmd = new G4UIcmdWithABool("/BetaChamber/generator/decay0/recycleFile",this);
...
BetaChamberGeneratorDecay0InterfaceMessenger::~BetaChamberGeneratorDecay0InterfaceMessenger()
{
  delete fDirectory;
  delete fCommand;
...
void BetaChamberGeneratorDecay0InterfaceMessenger::SetNewValue(G4UIcommand* cmd,G4String str)
{
  if (cmd == fCommand)
