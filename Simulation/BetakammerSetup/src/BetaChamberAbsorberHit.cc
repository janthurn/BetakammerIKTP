...
G4ThreadLocal G4Allocator<BetaChamberAbsorberHit>* BetaChamberAbsorberHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

BetaChamberAbsorberHit::BetaChamberAbsorberHit(): G4VHit(),
  // fCellID(-1),
...
BetaChamberAbsorberHit::~BetaChamberAbsorberHit()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

BetaChamberAbsorberHit::BetaChamberAbsorberHit(const BetaChamberAbsorberHit &right)
: G4VHit(),
...
const BetaChamberAbsorberHit& BetaChamberAbsorberHit::operator=(const BetaChamberAbsorberHit
                                                          &right)
{
  //fCellID = right.fCellID;
  fEdep = right.fEdep;
...
void BetaChamberAbsorberHit::Draw()
{
...
const std::map<G4String,G4AttDef>* BetaChamberAbsorberHit::GetAttDefs() const
{
  G4bool isNew;
  auto store = G4AttDefStore::GetInstance("BetaChamberAbsorberHit",isNew);
...
std::vector<G4AttValue>* BetaChamberAbsorberHit::CreateAttValues() const
{
  auto values = new std::vector<G4AttValue>;

  values
    ->push_back(G4AttValue("HitType","AbsorberHit",""));
  // values
...
void BetaChamberAbsorberHit::Print()
{
